            ...
            <div class="row product-details">
                    ...
                    <div class="product-details-thumb me-lg-6">
                        <div class="swiper single-product-thumb-slider">
                            <div class="swiper-wrapper">
                                <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="<?php echo $product->photo ?>">
                                    <img src="<?php echo $product->photo ?>" width="640" height="530" alt="Image">
                        ...
                        <div class="swiper single-product-nav-slider">
                            <div class="swiper-wrapper">
                                <div class="nav-item swiper-slide">
                                    <img src="<?php echo $product->photo ?>" alt="Image" width="305" height="253">
                                </div>
                                <div class="nav-item swiper-slide">
                                    <img src="<?php echo $product->photo ?>" alt="Image" width="305" height="253">
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="product-details-content">
                        <h3 class="product-details-title"><?php echo $product->name?></h3>
                        ...
                        <div class="product-details-price">$<?php echo $product->price ?> <span class="price-old">$<?php echo $product->price ?></span></div>
